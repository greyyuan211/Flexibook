...
public class Customer extends User implements Serializable
{
  ...
  public Customer(String aUsername, String aPassword, int aNumOfNoShows, FlexiBook aFlexiBook)
  {
    super(aUsername, aPassword);
    numOfNoShows = aNumOfNoShows;
  ...
  public boolean setNumOfNoShows(int aNumOfNoShows)
  {
  ...
  public String toString()
  {
    return super.toString() + "["+
            "numOfNoShows" + ":" + getNumOfNoShows()+ "]" + System.getProperties().getProperty("line.separator") +
