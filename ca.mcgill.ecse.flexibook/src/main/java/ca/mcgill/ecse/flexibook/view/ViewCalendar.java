...
public class ViewCalendar extends JPanel implements ActionListener{
	...
	/**
	 * @author Grey Yuan
	 * implement view calendar feature in the UI
	 */
	public ViewCalendar(FlexiAppPage app) {
		this.app = app;
		warning = null;
		setLayout(null);
		setSize(750,800);
		...
		dateLabel = new ColorfulLabel("Date:",blue,15);
        ...
        JLabel title = new ColorfulLabel("View Calendar", new Color(121, 134, 203), 25);
	...
	/**
	 * @author Grey Yuan
	 * update the table to include the available time and inavailable time in the canlendar table
	 */
	...
	/**
	 * @author Grey Yuan
	 * call updateTale as action performed
	 */
	@Override
