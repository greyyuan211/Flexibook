...
/**
 * @author jiang
 * Show a confirmed message to owner before logout
 */
public class LogoutOwner extends JPanel implements ActionListener{
	private JButton yes;
	private FlexiAppPage app;
	
	public LogoutOwner(FlexiAppPage app) {
		this.app = app;
		setLayout(null);
		setSize(750,800);
		...
		yes.setBackground(new Color(165, 214, 167));
